...
public class ServiceTracker<S, T, U extends ServiceEvent>
{
     ...
     * @since 1.1
     */
    public ServiceTracker(final BundleContext context, final ServiceTrackerCustomizer<S, T, U> customizer, boolean initialActive, ExtendedServiceListenerContext<U> bundleComponentActivator, final Filter eventFilter, final String classFilterString, final String initialReferenceFilterString)
    {
        if ((context == null))
        {
            /*
    ...
    public void open(boolean trackAllServices, AtomicInteger trackingCount)
    {
        ...
        synchronized (this)
        {
            ...
            synchronized (t)
            {
                try
                {
                    extendedServiceListenerContext.addServiceListener(classFilterString,
                        eventFilter, t);
                    ServiceReference<S>[] references = getInitialReferences(null,
     ...
     *         invalid syntax.
     */
    private ServiceReference<S>[] getInitialReferences(String className,
    ...
    public SortedMap<ServiceReference<S>, T> close(AtomicInteger trackingCount)
    {
        ...
        synchronized (this)
        {
            ...
            try
            {
                extendedServiceListenerContext.removeServiceListener(classFilterString,
                    eventFilter, outgoing);
            }
    ...
    abstract class AbstractTracked<S, T, R>
    {
            ...
            while (true)
            {
                ...
                synchronized (this)
                {
                    ...
                    if (tracked.get(item) != null)
                    {
                        ...
                        {
                            System.out.println(
                                "AbstractTracked.trackInitial[already tracked]: " + item); //$NON-NLS-1$
                        }
                    ...
                    if (adding.contains(item))
                    {
                        ...
                        {
                            System.out.println(
                                "AbstractTracked.trackInitial[already adding]: " + item); //$NON-NLS-1$
                        }
                        continue; /* skip this item */
                    }
                    adding.add(item);
            ...
            synchronized (this)
            {
                ...
                { /* we are not tracking the item */
                    if (adding.contains(item))
                    {
                        ...
                        {
                            System.out.println(
                                "AbstractTracked.track[already adding]: " + item); //$NON-NLS-1$
                        }
                        return;
                    }
            ...
            synchronized (this)
            {
                ...
                { /*
                   ...
                   */
                    ...
                    {
                        System.out.println(
                            "AbstractTracked.untrack[removed from initial]: " + item); //$NON-NLS-1$
                    }
                    return; /*
                ...
                { /*
                    ...
                    */
                    ...
                    {
                        System.out.println(
                            "AbstractTracked.untrack[being added]: " + item); //$NON-NLS-1$
                    }
                    return; /*
        ...
        abstract void customizerAdded(final S item, final R related, final T object,
            int trackingCount, int serviceCount);
    ...
    private class Tracked extends AbstractTracked<ServiceReference<S>, T, U> implements ExtendedServiceListener<U>
    {
        ...
        final void customizerAdded(final ServiceReference<S> item, final U related,
            final T object, int trackingCount, int serviceCount)
        {
         ...
         * @param trackingCount
         */
        final void customizerModified(final ServiceReference<S> item, final U related,
            final T object, int trackingCount)
        {
         ...
         * @param trackingCount
         */
        final void customizerRemoved(final ServiceReference<S> item, final U related,
            final T object, int trackingCount)
        {
