...
public class ServiceFactoryComponentManager<S> extends SingleComponentManager<S>
{
    ...
    public void setServiceProperties(Dictionary<String, ?> serviceProperties)
    {
        throw new IllegalStateException(
            "Bundle or instance scoped service properties are immutable");
    }
    ...
    public S getService(Bundle bundle, ServiceRegistration<S> serviceRegistration)
    {
        ...
        {
            log(LogService.LOG_DEBUG,
                "getService (ServiceFactory) dependencies collected.", null);
        ...
        S service = createImplementationObject(bundle, new SetImplementationObject<S>()
        {
            public void presetComponentContext(ComponentContextImpl<S> componentContext)
            {
                ...
                {
                    serviceContexts.put(componentContext.getImplementationObject(false),
                        componentContext);
                }
            }
        ...
        S service)
    {
        ...
        disposeImplementationObject(serviceContext,
        ...
        RefPair<S, T> refPair, int trackingCount)
    {
        ...
        {
            dependencyManager.invokeBindMethod(cc, refPair, trackingCount,
        ...
        RefPair<S, T> oldRefPair, int trackingCount)
    {
        for (ComponentContextImpl<S> cc : getComponentContexts())
        {
            dependencyManager.invokeUnbindMethod(cc, oldRefPair, trackingCount,
                cc.getEdgeInfo(dependencyManager));
        }
    }
    ...
    protected MethodResult invokeModifiedMethod()
    {
        ...
        for (ComponentContextImpl<S> componentContext : getComponentContexts())
        {
            ...
            result = modifiedMethod.invoke(instance, componentContext, -1,
