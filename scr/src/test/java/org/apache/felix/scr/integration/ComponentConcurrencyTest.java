...
public class ComponentConcurrencyTest extends ComponentTestBase
{
    static
    {
        ...
        ignoredWarnings = new String[] { "FrameworkEvent: ERROR", "FrameworkEvent ERROR",
                "Could not get service from ref", "Failed creating the component instance; see log for reason",
    ...
    public void test_concurrent_component_activation_using_componentFactories() throws Exception
    {
        ...
        ComponentConfigurationDTO ccA = getDisabledConfigurationAndEnable(
            "org.apache.felix.scr.integration.components.concurrency.AFactory", ComponentConfigurationDTO.ACTIVE );
        ComponentConfigurationDTO ccC = getDisabledConfigurationAndEnable(
            "org.apache.felix.scr.integration.components.concurrency.CFactory", ComponentConfigurationDTO.ACTIVE );
