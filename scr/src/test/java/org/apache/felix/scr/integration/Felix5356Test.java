...
public class Felix5356Test extends ComponentTestBase
{
    ...
    @Test
    public void test_factory_component_instance_with_factory_configuration_after_enable()
        throws Exception
    {
    ...
    @Test
    public void test_factory_component_instance_with_factory_configuration_before_enable()
        throws Exception
    {
        do_test_factory_component_with_factory_configuration(true);
    }

    private void do_test_factory_component_with_factory_configuration(
        boolean createConfigBeforeEnable) throws Exception
    {
    ...
    private void findServices(String clazz, String filter, int expected)
        throws InvalidSyntaxException
    {
        ...
        TestCase.assertEquals(
            "Wrong number of services found for clazz \"" + clazz + "\" and filter \""
                + filter + "\" found: " + Arrays.toString(services),
