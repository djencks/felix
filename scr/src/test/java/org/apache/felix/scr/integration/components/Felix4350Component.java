...
public class Felix4350Component
{
    ...
    public static void check(int activateCount, int deactivateCount, boolean activated)
    {
        ...
        {
            String message = "activation: expected " + activateCount + " actual "
                + m_activateCount + " deactivation: expected " + deactivateCount
                + " actual " + m_deactivateCount + " activated: expected " + activated
                + " actual " + (m_instance != null);
