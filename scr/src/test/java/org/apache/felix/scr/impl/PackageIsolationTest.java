...
public class PackageIsolationTest extends TestCase
{
    ...
    {
        final List<String> packages = Arrays.asList("org/apache/felix/scr/component",
            "org/apache/felix/scr/impl/helper", "org/apache/felix/scr/impl/manager",
        ...
        {
            if (pkg.startsWith("org/apache/felix/scr") && !packages.contains(pkg))
            {
        ...
        void addTypeSignature(final String signature)
        {
            if (signature != null)
            {
                new SignatureReader(signature).acceptType(
                    new SignatureDependencyVisitor());
            }
        }
