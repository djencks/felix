...
public class Felix4188Test extends ComponentTestBase
{
    ...
    public void test_concurrent_deactivation() throws Exception
    {
        ...
        final ComponentConfigurationDTO aComp1 = findComponentConfigurationByName( bundle1,
            "org.apache.felix.scr.integration.components.Felix4188Component-1", ComponentConfigurationDTO.SATISFIED );
        ...
        final ComponentConfigurationDTO aComp2 = findComponentConfigurationByName( bundle2,
            "org.apache.felix.scr.integration.components.Felix4188Component-2", ComponentConfigurationDTO.SATISFIED );
    ...
    private Object getServiceFromConfigurationInAllClassSpaces(ComponentConfigurationDTO dto, String clazz)
        ...
        throws BundleException
    {
        final InputStream bundleStream = bundle().add( "OSGI-INF/components.xml",
            ...
            .set( Constants.BUNDLE_SYMBOLICNAME, symbolicname ).set( Constants.BUNDLE_VERSION, "0.0.11" ).set(
                Constants.IMPORT_PACKAGE, componentPackage ).set( "Service-Component",
