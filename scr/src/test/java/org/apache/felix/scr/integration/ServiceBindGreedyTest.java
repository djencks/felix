...
public class ServiceBindGreedyTest extends ComponentTestBase
{
    ...
    public void test_optional_single_dynamic() throws Exception
    {
        ...
        ComponentConfigurationDTO cc = getDisabledConfigurationAndEnable(name,
        ...
        final SimpleServiceImpl srv5 = SimpleServiceImpl.create(bundleContext, "srv5",
            10);
        final SimpleServiceImpl srv6 = SimpleServiceImpl.create(bundleContext, "srv6",
            20);
        ...
        final SimpleServiceImpl srv7 = SimpleServiceImpl.create(bundleContext, "srv7",
            30);
        delay();
