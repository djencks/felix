...
public class ConfiguredComponentHolderTest extends TestCase
{
    ...
    public void test_none()
    {
        ...
        final TestingConfiguredComponentHolder holder = new TestingConfiguredComponentHolder(
            cm);
        ...
        assertEquals("Expect no other component manager list", 1,
            getComponentManagers(holder).size());
    }
    ...
    public void test_factory()
    {
        ...
        final SingleComponentManager cmgrAfterConfig = getSingleManager(holder);
        final List<SingleComponentManager> cmgrsAfterConfig = getComponentManagers(
            holder);
        assertNotNull("Expect single component manager", cmgrAfterConfig);
        ...
        final List<SingleComponentManager> cmgrsAfterConfig2 = getComponentManagers(
            holder);
        ...
        final List<SingleComponentManager> cmgrsAfterUnConfig2 = getComponentManagers(
            holder);
        ...
        // assert single component and single-entry map
        final List<SingleComponentManager> cmgrsAfterConfigUnconfig = getComponentManagers(
            holder);
        ...
        // assert single component and single-entry map
        final List<SingleComponentManager> cmgrsAfterAllUnconfig = getComponentManagers(
            holder);
    ...
    private static SingleComponentManager getSingleManager(
        ConfigurableComponentHolder holder)
    {
    ...
    private static List<SingleComponentManager> getComponentManagers(
        ConfigurableComponentHolder holder)
    {
