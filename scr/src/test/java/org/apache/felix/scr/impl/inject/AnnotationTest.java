...
public class AnnotationTest extends TestCase
{
    ...
    private Bundle mockBundle() throws ClassNotFoundException
    {
        ...
        EasyMock.expect(b.loadClass(String.class.getName())).andReturn(
            (Class) String.class).anyTimes();
        EasyMock.expect(b.loadClass(Integer.class.getName())).andReturn(
            (Class) Integer.class).anyTimes();
        EasyMock.replay(b);
        return b;
    }
