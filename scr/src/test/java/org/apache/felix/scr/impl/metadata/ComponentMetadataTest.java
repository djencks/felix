...
public class ComponentMetadataTest extends TestCase
{
    ...
    public void testFactory()
    {
        ...
        try
        {
            ...
            fail(
                "Expect validation failure for immediate factory component with service factory");
        }
        catch (ComponentException ce)
        {
            // expect
    ...
    public void test_component_no_name_ds11()
    {
        ...
        cm1.setName(null);
        cm1.validate(logger);
        assertEquals("Expected name to equal implementation class name",
            cm1.getImplementationClassName(), cm1.getName());
    }
    ...
    public void test_component_activate_ds10()
    {
        ...
        assertFalse("Activate method expected to not be declared",
            cm1.isActivateDeclared());
    ...
    public void test_component_deactivate_ds10()
    {
        ...
        assertFalse("Deactivate method expected to not be declared",
            cm1.isDeactivateDeclared());
    ...
    public void test_component_deactivate_ds11()
    {
        ...
        assertTrue("Deactivate method expected to be declared",
            cm2.isDeactivateDeclared());
    }
    ...
    public void test_component_configuration_policy_ds10()
    {
        final ComponentMetadata cm1 = createComponentMetadata(Boolean.TRUE, null);
        cm1.validate(logger);
        assertEquals("Configuration policy",
    ...
    public void test_component_configuration_policy_ds11()
    {
        ...
        cm2.validate(logger);
        assertEquals("Configuration policy",
            ComponentMetadata.CONFIGURATION_POLICY_IGNORE, cm2.getConfigurationPolicy());
        ...
        cm4.validate(logger);
        assertEquals("Configuration policy",
            ComponentMetadata.CONFIGURATION_POLICY_REQUIRE, cm4.getConfigurationPolicy());
    ...
    public void test_reference_no_name_ds11()
    {
        ...
        cm4.validate(logger);
        assertEquals("Reference name defaults to interface", rm4.getInterface(),
            rm4.getName());
    }
    ...
    public void test_reference_updated_ds11_felix()
    {
        ...
        final ReferenceMetadata rm3 = createReferenceMetadata("test");
        rm3.setUpdated("my_updated_method");
        final ComponentMetadata cm3 = createComponentMetadata(DSVersion.DS11Felix,
            Boolean.TRUE, null);
        cm3.addDependency(rm3);
    ...
    public void test_reference_updated_ds12()
    {
        ...
        final ReferenceMetadata rm3 = createReferenceMetadata("test");
        rm3.setUpdated("my_updated_method");
        final ComponentMetadata cm3 = createComponentMetadata(DSVersion.DS12,
            Boolean.TRUE, null);
        cm3.addDependency(rm3);
    ...
    {
        final ComponentMetadata cm = createComponentMetadata(null, null);
        PropertyMetadata prop = createPropertyMetadata("x", "Char",
            Integer.toString('x'));
        cm.addProperty(prop);
        cm.validate(logger);
    ...
    public void test_configuration_pid_use_ds12()
    {
        ...
        try
        {
            ...
            cm.validate(logger);
            fail(
                "Expect validation failure for illegal configuration-pid usage in ds 1.1 namespace");
        }
        catch (ComponentException ce)
        {
            // expected
        ...
        catch (ComponentException ce)
        {
            ce.printStackTrace();
            fail(
                "Expect correct validation for legal configuration-pid usage in ds 1.2 or later namespace");
        }
    }
    ...
    private void doTest_get_configuration_pid_method(DSVersion specVersion)
    {
        ...
        if (specVersion.isDS11())
        {
            ...
            assertFalse(
                "Expect non-null configuration pid when component name is not specified",
                pid.isEmpty());
            assertEquals(
                "Expect configuration-pid to be equals to component implementation",
    ...
    {
        final ComponentMetadata cm = createComponentMetadata11(null, null);
        PropertyMetadata prop = createPropertyMetadata("x", "Character",
            Integer.toString('x'));
        cm.addProperty(prop);
        cm.validate(logger);
        assertTrue(prop.getValue() instanceof Character);
    ...
    static void failDS10Validation(final ComponentMetadata metadata,
        final String expectedValidationReason, final MockLogger logger)
    {
        try
        {
            metadata.validate(logger);
            fail("Expected validation failure for Component " + metadata.getName()
                + " containing '" + expectedValidationReason + "'");
        }
        catch (ComponentException ce)
        {
            assertTrue(
                "Expected validation reason to contain '" + expectedValidationReason
                    + "': actual: " + ce.getMessage(),
                ce.getMessage().indexOf(expectedValidationReason) >= 0);
        }
    }

    // Creates Component Metadata for the given namespace
    private ComponentMetadata createComponentMetadata(DSVersion dsVersion,
        Boolean immediate, String factory)
    {
    ...
    private PropertyMetadata createPropertyMetadata(String propertyName, String type,
        String value)
    {
    ...
    {
        PropertyMetadata meta = createPropertyMetadata("dummy", type,
    ...
    private void assertPropertyArrayFail(String type, String value,
